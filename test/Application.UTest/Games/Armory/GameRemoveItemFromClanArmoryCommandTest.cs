...
public class GameRemoveItemFromClanArmoryCommandTest : TestBase
{
    ...
    public async Task ShouldRemove()
    {
        ...
        var handler = new GameRemoveItemFromClanArmoryCommand.Handler(ActDb, ClanService, ActivityLogService.Object);
        var result = await handler.Handle(new GameRemoveItemFromClanArmoryCommand
        {
