...
public class GameReturnItemToClanArmoryCommandTest : TestBase
{
    ...
    public async Task ShouldReturn()
    {
        ...
        var handler = new GameReturnItemToClanArmoryCommand.Handler(ActDb, ClanService, ActivityLogService.Object, UserNotificationsService.Object);
        var result = await handler.Handle(new GameReturnItemToClanArmoryCommand
        {
