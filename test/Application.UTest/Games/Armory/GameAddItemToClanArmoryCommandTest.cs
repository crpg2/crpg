...
public class GameAddItemToClanArmoryCommandTest : TestBase
{
    ...
    public async Task ShouldAdd()
    {
        ...
        var handler = new GameAddItemToClanArmoryCommand.Handler(ActDb, Mapper, ClanService, ActivityLogService.Object);
        var result = await handler.Handle(new GameAddItemToClanArmoryCommand
        {
            UserItemId = item.Id,
            UserId = user.Id,
