...
public class UpdateGameCharacterItemsCommandTest : TestBase
{
    ...
    public async Task FullUpdate()
    {
        ...
        var handler = new UpdateGameCharacterItemsCommand.Handler(ActDb, CreateCharacterService(), CreateMapper());
    ...
    public async Task CharacterNotFound()
    {
        ...
        var handler = new UpdateGameCharacterItemsCommand.Handler(ActDb, CreateCharacterService(), CreateMapper());
        var result = await handler.Handle(new UpdateGameCharacterItemsCommand
        {
            CharacterId = 1,
    ...
    public async Task ItemNotOwned()
    {
        ...
        var result = await handler.Handle(new UpdateGameCharacterItemsCommand
        {
            ...
            Items = new List<EquippedItemIdViewModel>
            {
                new() { UserItemId = userItem.Id, Slot = ItemSlot.Head },
            },
        }, CancellationToken.None);
    ...
    public async Task WrongSlotForItemType(ItemType itemType, ItemSlot itemSlot)
    {
        ...
        User user = new() { Items = { userItem }, Characters = { character } };
        ArrangeDb.Users.Add(user);
        await ArrangeDb.SaveChangesAsync();
    ...
    public async Task DropOnWeaponChangeItemOnWeaponSlot(ItemFlags itemFlags)
    {
        ...
        UserItem userItem = new()
        {
            Item = new Item { Type = ItemType.Banner, Flags = itemFlags, Enabled = true },
        };
        User user = new() { Items = { userItem }, Characters = { character } };
        ArrangeDb.Users.Add(user);
        await ArrangeDb.SaveChangesAsync();
