...
public class UpdateGameCharacterCharacteristicsCommandTest : TestBase
{
    ...
    public async Task ShouldUpdateIfEnoughPoints()
    {
        ...
        UpdateGameCharacterCharacteristicsCommand.Handler handler = new(ActDb, Mapper, Mock.Of<ICharacterClassResolver>(), Constants);
        var result = await handler.Handle(new UpdateGameCharacterCharacteristicsCommand
        {
    ...
    public async Task IncreaseAgilityShouldIncreaseWeaponProficienciesPoints()
    {
        ...
        result = await handler.Handle(new UpdateGameCharacterCharacteristicsCommand
        {
            CharacterId = character.Entity.Id,
            UserId = character.Entity.UserId,
            Characteristics = new CharacterCharacteristicsViewModel
