...
internal class AcceptMarketplaceOfferTransferTest : AcceptMarketplaceOfferCommandTestBase
{
    [Test]
    ...
    public async Task ShouldSucceedWhenBuyerHasExactlyEnoughGold()
    {
        ...
        var offer = CreateOffer(seller.Id, requestedGold: 100);
        ArrangeDb.MarketplaceOffers.Add(offer);
        await ArrangeDb.SaveChangesAsync();
    ...
    public async Task ShouldTransferHeirloomPointsCorrectlyOnPureHeirloomTrade()
    {
        ...
        var offer = CreateOffer(seller.Id, offeredHeirloomPoints: 2, requestedHeirloomPoints: 5);
        ArrangeDb.MarketplaceOffers.Add(offer);
        await ArrangeDb.SaveChangesAsync();
    ...
    [Test]
    public async Task ShouldRemoveOfferAfterAccept()
    {
        User seller = new();
        ...
        var offer = CreateOffer(seller.Id, offeredGold: 10, requestedGold: 50);
        ArrangeDb.MarketplaceOffers.Add(offer);
        await ArrangeDb.SaveChangesAsync();

        await CreateHandler().Handle(new AcceptMarketplaceOfferCommand
        {
            UserId = buyer.Id,
            OfferId = offer.Id,
        }, CancellationToken.None);
    ...
    public async Task ShouldTransferOfferedItemToBuyerInItemForGoldTrade()
    {
        ...
        var offer = CreateOffer(seller.Id, offeredUserItemId: sellerItem.Id, requestedGold: 200);
        ArrangeDb.MarketplaceOffers.Add(offer);
        await ArrangeDb.SaveChangesAsync();
    ...
    public async Task ShouldTransferRequestedItemToSellerInGoldForItemTrade()
    {
        ...
        var offer = CreateOffer(seller.Id, offeredGold: 100, requestedItemId: "shield");
        ArrangeDb.MarketplaceOffers.Add(offer);
        await ArrangeDb.SaveChangesAsync();
    ...
    public async Task ShouldSwapBothItemsInItemForItemTrade()
    {
        ...
        var offer = CreateOffer(seller.Id, offeredUserItemId: sellerItem.Id, requestedItemId: "shield");
        ArrangeDb.MarketplaceOffers.Add(offer);
        await ArrangeDb.SaveChangesAsync();
