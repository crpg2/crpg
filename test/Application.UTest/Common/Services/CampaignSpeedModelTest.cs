...
public class CampaignSpeedModelTest
{
    [Test]
    public void TroopsShouldUseTheBestMountTheyHave()
    {
        ...
        CampaignSpeedModel speedModel = CreateSpeedModel();
    ...
    public void IdenticalTroopsWithDifferentTerrainShouldHaveDifferentSpeed()
    {
        ...
        CampaignSpeedModel speedModel = CreateSpeedModelWithTerrainMultipliers();
    ...
    private static CampaignSpeedModel CreateSpeedModel()
    {
        var mockRouting = new Mock<ICampaignRouting>();
        mockRouting.Setup(m => m.GetTerrainSpeedMultiplier(It.IsAny<TerrainType?>()))
            .Returns(1.0);
        return new CampaignSpeedModel(mockRouting.Object);
    }

    private static CampaignSpeedModel CreateSpeedModelWithTerrainMultipliers()
    {
        var mockRouting = new Mock<ICampaignRouting>();
