...
public class CampaignMapTest
{
    ...
    {
        CampaignMapWidth = 1000,
        CampaignMapHeight = 1000,
        CampaignEquivalentDistance = 0.5,
        CampaignInteractionDistance = 2,
        CampaignSpawningPositionCenter = new[] { 10.0, 20.0 },
        CampaignSpawningPositionRadius = 5.0,
    };
    private static readonly CampaignMap CampaignMap = new(Constants, new ThreadSafeRandom());
    ...
    public void ArePointsEquivalentShouldReturnTrueIfPointsAreClose()
    {
        ...
        Assert.That(CampaignMap.ArePointsEquivalent(p1, p2), Is.True);
    }
    ...
    public void ArePointsEquivalentShouldReturnFalseIfPointsAreFar()
    {
        Point p1 = new(0, 0);
        Point p2 = new(10, 10);
        Assert.That(CampaignMap.ArePointsEquivalent(p1, p2), Is.False);
    }
    ...
    public void ArePointsAtInteractionDistanceShouldReturnTrueIfPointsAreClose()
    {
        ...
        Point p2 = new(1, 0.5);
        Assert.That(CampaignMap.ArePointsAtInteractionDistance(p1, p2), Is.True);
    }
    ...
    public void ArePointsAtInteractionDistanceShouldReturnFalseIfPointsAreFar()
    {
        ...
        Assert.That(CampaignMap.ArePointsAtInteractionDistance(p1, p2), Is.False);
    }
    ...
    public void MovePointTowardsShouldReturnMovedPoint()
    {
        Point p1 = new(0, 0);
        Point p2 = new(100, 100);
        var p3 = CampaignMap.MovePointTowards(p1, p2, 1);
    ...
    public void MovePointTowardsShouldNotMoveFurtherThanTarget()
    {
        Point p1 = new(0, 0);
        Point p2 = new(100, 100);
        var p3 = CampaignMap.MovePointTowards(p1, p2, 10000000);
    ...
    {
        Point p1 = new(4, 7);
        Point p2 = CampaignMap.TranslatePositionForRegion(p1, source, target);
    ...
    {
        var spawnPosition = CampaignMap.GetSpawnPosition(Region.Eu);
        Assert.That(spawnPosition.X, Is.EqualTo(Constants.CampaignSpawningPositionCenter[0]).Within(Constants.CampaignSpawningPositionRadius));
        Assert.That(spawnPosition.Y, Is.EqualTo(Constants.CampaignSpawningPositionCenter[1]).Within(Constants.CampaignSpawningPositionRadius));
    }
}
