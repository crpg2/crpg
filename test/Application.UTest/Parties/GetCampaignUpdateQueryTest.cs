...
public class GetCampaignUpdateQueryTest : TestBase
{
    // [Test]
    // public async Task ShouldReturnErrorIfNotFound()
    // {
    //     GetCampaignUpdateQuery.Handler handler = new(ActDb, Mapper, Mock.Of<ICampaignMap>());
    //     var res = await handler.Handle(new GetCampaignUpdateQuery
    //     {
    //         PartyId = 1,
    ...
    // [Test]
    // public async Task ShouldReturnErrorIfNotRegisteredToCampaign()
    // {
    //     User user = new();
    ...
    //     campaignMapMock.Setup(m => m.ViewDistance).Returns(50);

    // GetCampaignUpdateQuery.Handler handler = new(ActDb, Mapper, campaignMapMock.Object);
    //     var res = await handler.Handle(new GetCampaignUpdateQuery
    //     {
    //         PartyId = party.Id,
    //     }, CancellationToken.None);
