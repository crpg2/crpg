...
<template>
  <div class="p-4">
    <div class="mb-32 max-w-3xl">
      <UiTextView tag="h1" variant="h1">
        Until now, trying to style an article
      </UiTextView>

      <UiTextView tag="h2" variant="h2">
        Until now, trying to style an article
      </UiTextView>

      <UiTextView tag="h3" variant="h3">
        Until now, trying to style an article
      </UiTextView>

      <UiTextView tag="h4" variant="h4">
        Until now, trying to style an article
      </UiTextView>
      ...
      <UiListView>
        <UiListViewItem label="Until now, trying to style an article" />
        <UiListViewItem>
          Until now, trying to style an article
        </UiListViewItem>
      </UiListView>
