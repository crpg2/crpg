export const pollUserCharactersSymbol = Symbol('pollUserCharacters')
export const pollUserItemsSymbol = Symbol('pollUserItems')

export const pollCharacterItemsSymbol = Symbol('pollCharacterItems')
