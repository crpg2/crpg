...
import type { GetActivityLogsResponse, GetActivityLogsData, GetBattlesResponse, GetBattlesData, GetBattlesByBattleIdResponse, GetBattlesByBattleIdData, GetBattlesByBattleIdFightersResponse, GetBattlesByBattleIdFightersData, PostBattlesByBattleIdFightersResponse, PostBattlesByBattleIdFightersData, GetBattlesByBattleIdFighterApplicationsResponse, GetBattlesByBattleIdFighterApplicationsData, PutBattlesByBattleIdFighterApplicationsByApplicationIdResponseResponse, PutBattlesByBattleIdFighterApplicationsByApplicationIdResponseData, GetBattlesByBattleIdMercenariesResponse, GetBattlesByBattleIdMercenariesData, GetBattlesByBattleIdMercenaryApplicationsResponse, GetBattlesByBattleIdMercenaryApplicationsData, PostBattlesByBattleIdMercenaryApplicationsResponse, PostBattlesByBattleIdMercenaryApplicationsData, PutBattlesByBattleIdMercenaryApplicationsByApplicationIdResponseResponse, PutBattlesByBattleIdMercenaryApplicationsByApplicationIdResponseData, GetClansByIdResponse, GetClansByIdData, GetClansByIdMembersResponse, GetClansByIdMembersData, DeleteClansByClanIdMembersByUserIdResponse, DeleteClansByClanIdMembersByUserIdData, PutClansByClanIdMembersByUserIdResponse, PutClansByClanIdMembersByUserIdData, GetClansResponse, GetClansData, PostClansResponse, PostClansData, PutClansByClanIdResponse, PutClansByClanIdData, GetClansByClanIdInvitationsResponse, GetClansByClanIdInvitationsData, PostClansByClanIdInvitationsResponse, PostClansByClanIdInvitationsData, PutClansByClanIdInvitationsByInvitationIdResponseResponse, PutClansByClanIdInvitationsByInvitationIdResponseData, GetClansByClanIdArmoryResponse, GetClansByClanIdArmoryData, PostClansByClanIdArmoryResponse, PostClansByClanIdArmoryData, DeleteClansByClanIdArmoryByUserItemIdResponse, DeleteClansByClanIdArmoryByUserItemIdData, PutClansByClanIdArmoryByUserItemIdBorrowResponse, PutClansByClanIdArmoryByUserItemIdBorrowData, PutClansByClanIdArmoryByUserItemIdReturnData, GetConnectAuthorizeData, PostConnectAuthorizeData, PostConnectTokenData, GetConnectCallbackEpicGamesData, GetConnectCallbackMicrosoftData, GetConnectLogoutData, GetGameServerStatisticsResponse, GetGameServerStatisticsData, GetGamesUsersResponse, GetGamesUsersData, PutGamesUsersResponse, PutGamesUsersData, GetGamesTournamentUsersResponse, GetGamesTournamentUsersData, PostGamesActivityLogsData, GetGamesClansByIdResponse, GetGamesClansByIdData, PostGamesRestrictionsResponse, PostGamesRestrictionsData, GetItemsResponse, GetItemsData, GetItemsUpgradesByBaseIdResponse, GetItemsUpgradesByBaseIdData, PutItemsByIdEnableResponse, PutItemsByIdEnableData, PostItemsByIdRefundData, GetLeaderboardLeaderboardResponse, GetLeaderboardLeaderboardData, GetPartiesSelfUpdateResponse, GetPartiesSelfUpdateData, PostPartiesResponse, PostPartiesData, PutPartiesSelfStatusResponse, PutPartiesSelfStatusData, PostPartiesSelfItemsResponse, PostPartiesSelfItemsData, GetPatchNotesResponse, GetPatchNotesData, GetRestrictionsResponse, GetRestrictionsData, PostRestrictionsResponse, PostRestrictionsData, GetSettingsResponse, GetSettingsData, PatchSettingsResponse, PatchSettingsData, GetSettlementsResponse, GetSettlementsData, GetSettlementsBySettlementIdResponse, GetSettlementsBySettlementIdData, PostSettlementsBySettlementIdResponse, PostSettlementsBySettlementIdData, GetSettlementsBySettlementIdItemsResponse, GetSettlementsBySettlementIdItemsData, PostSettlementsBySettlementIdItemsResponse, PostSettlementsBySettlementIdItemsData, GetSettlementsBySettlementIdShopItemsResponse, GetSettlementsBySettlementIdShopItemsData, GetTerrainsResponse, GetTerrainsData, PostTerrainsResponse, PostTerrainsData, DeleteTerrainsByIdData, PutTerrainsByIdResponse, PutTerrainsByIdData, GetUsersSearchResponse, GetUsersSearchData, DeleteUsersSelfResponse, DeleteUsersSelfData, GetUsersSelfResponse, GetUsersSelfData, PutUsersSelfResponse, PutUsersSelfData, GetUsersByUserIdResponse, GetUsersByUserIdData, PutUsersByUserIdNoteResponse, PutUsersByUserIdNoteData, GetUsersByUserIdCharactersResponse, GetUsersByUserIdCharactersData, GetUsersResponse, GetUsersData, GetUsersByIdRestrictionsResponse, GetUsersByIdRestrictionsData, GetUsersSelfRestrictionResponse, GetUsersSelfRestrictionData, PutUsersByIdRewardsResponse, PutUsersByIdRewardsData, DeleteUsersSelfCharactersByIdResponse, DeleteUsersSelfCharactersByIdData, GetUsersSelfCharactersByIdResponse, GetUsersSelfCharactersByIdData, PutUsersSelfCharactersByIdResponse, PutUsersSelfCharactersByIdData, GetUsersSelfCharactersResponse, GetUsersSelfCharactersData, GetUsersSelfCharactersByIdCharacteristicsResponse, GetUsersSelfCharactersByIdCharacteristicsData, PutUsersSelfCharactersByIdCharacteristicsResponse, PutUsersSelfCharactersByIdCharacteristicsData, PutUsersCharactersCompetitiveRatingsData, PutUsersCharactersRespecializeData, PutUsersSelfCharactersByIdCharacteristicsConvertResponse, PutUsersSelfCharactersByIdCharacteristicsConvertData, GetUsersSelfCharactersByIdItemsResponse, GetUsersSelfCharactersByIdItemsData, PutUsersSelfCharactersByIdItemsResponse, PutUsersSelfCharactersByIdItemsData, PutUsersSelfCharactersByIdActiveResponse, PutUsersSelfCharactersByIdActiveData, GetUsersSelfCharactersByIdStatisticsResponse, GetUsersSelfCharactersByIdStatisticsData, GetUsersSelfCharactersByIdEarningStatisticsResponse, GetUsersSelfCharactersByIdEarningStatisticsData, GetUsersSelfCharactersByIdLimitationsResponse, GetUsersSelfCharactersByIdLimitationsData, PutUsersByUserIdCharactersByIdRetireResponse, PutUsersByUserIdCharactersByIdRetireData, PutUsersSelfCharactersByIdRetireResponse, PutUsersSelfCharactersByIdRetireData, PutUsersSelfCharactersByIdRespecializeResponse, PutUsersSelfCharactersByIdRespecializeData, PutUsersSelfCharactersByIdTournamentResponse, PutUsersSelfCharactersByIdTournamentData, PutUsersByUserIdCharactersByCharacterIdRewardsResponse, PutUsersByUserIdCharactersByCharacterIdRewardsData, GetUsersSelfItemsResponse, GetUsersSelfItemsData, PostUsersSelfItemsResponse, PostUsersSelfItemsData, PutUsersSelfItemsByIdReforgeResponse, PutUsersSelfItemsByIdReforgeData, PutUsersSelfItemsByIdRepairResponse, PutUsersSelfItemsByIdRepairData, PutUsersSelfItemsByIdUpgradeResponse, PutUsersSelfItemsByIdUpgradeData, DeleteUsersSelfItemsByIdResponse, DeleteUsersSelfItemsByIdData, GetUsersSelfClanResponse, GetUsersSelfClanData, GetUsersRewardRecentData, GetUsersSelfNotificationsResponse, GetUsersSelfNotificationsData, DeleteUsersSelfNotificationsByIdResponse, DeleteUsersSelfNotificationsByIdData, PutUsersSelfNotificationsByIdResponse, PutUsersSelfNotificationsByIdData, PutUsersSelfNotificationsReadAllResponse, PutUsersSelfNotificationsReadAllData, DeleteUsersSelfNotificationsDeleteAllResponse, DeleteUsersSelfNotificationsDeleteAllData } from './types.gen';
import { getActivityLogsResponseTransformer, getBattlesResponseTransformer, getBattlesByBattleIdResponseTransformer, getClansByClanIdArmoryResponseTransformer, getGamesUsersResponseTransformer, putGamesUsersResponseTransformer, getGamesTournamentUsersResponseTransformer, postGamesRestrictionsResponseTransformer, getItemsResponseTransformer, getItemsUpgradesByBaseIdResponseTransformer, getPartiesSelfUpdateResponseTransformer, postPartiesSelfItemsResponseTransformer, getPatchNotesResponseTransformer, getRestrictionsResponseTransformer, getSettlementsBySettlementIdItemsResponseTransformer, postSettlementsBySettlementIdItemsResponseTransformer, getSettlementsBySettlementIdShopItemsResponseTransformer, getUsersSearchResponseTransformer, getUsersByUserIdResponseTransformer, putUsersByUserIdNoteResponseTransformer, getUsersResponseTransformer, getUsersByIdRestrictionsResponseTransformer, getUsersSelfRestrictionResponseTransformer, getUsersSelfCharactersByIdItemsResponseTransformer, putUsersSelfCharactersByIdItemsResponseTransformer, getUsersSelfCharactersByIdEarningStatisticsResponseTransformer, getUsersSelfCharactersByIdLimitationsResponseTransformer, getUsersSelfItemsResponseTransformer, postUsersSelfItemsResponseTransformer, putUsersSelfItemsByIdReforgeResponseTransformer, putUsersSelfItemsByIdRepairResponseTransformer, putUsersSelfItemsByIdUpgradeResponseTransformer, getUsersSelfNotificationsResponseTransformer, putUsersSelfNotificationsByIdResponseTransformer } from './transformers.gen';
