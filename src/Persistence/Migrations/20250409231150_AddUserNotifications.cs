    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                user_notification_id = table.Column<int>(type: "integer", nullable: true),
            },
            constraints: table =>
            {
                table.PrimaryKey("pk_notification_metadata", x => new { x.notification_id, x.key });
                table.ForeignKey(
                    name: "fk_notification_metadata_user_notifications_user_notification_",
        ...
        migrationBuilder.CreateIndex(
            name: "ix_notification_metadata_user_notification_id",
