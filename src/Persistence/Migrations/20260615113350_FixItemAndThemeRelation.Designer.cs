...
namespace Crpg.Persistence.Migrations
{
    ...
    [Migration("20260615113350_FixItemAndThemeRelation")]
    partial class FixItemAndThemeRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "theme_equipment_slot", new[] { "body", "hand", "head", "leg", "mount", "mount_harness", "shoulder", "weapon0", "weapon1", "weapon2", "weapon3", "weapon_extra" });
            ...
            modelBuilder.Entity("Crpg.Domain.Entities.Quests.QuestDefinition", b =>
                {
                    ...
                    b.Property<int?>("AggregationField")
                        .HasColumnType("integer")
                        .HasColumnName("aggregation_field");
            ...
            modelBuilder.Entity("Crpg.Domain.Entities.Themes.Theme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Crpg.Domain.Entities.Themes.ThemeEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("EventThemeId")
                        .HasColumnType("integer")
                        .HasColumnName("event_theme_id");

                    b.Property<float>("ExpMultiplier")
                        .HasColumnType("real")
                        .HasColumnName("exp_multiplier");
                    ...
                    b.PrimitiveCollection<List<ThemeEquipmentSlot>>("RequiredEquipmentSlotsMatchingTheme")
                        .IsRequired()
                        .HasColumnType("theme_equipment_slot[]")
                        .HasColumnName("required_equipment_slots_matching_theme");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_theme_events");

                    b.HasIndex("EventThemeId")
                        .HasDatabaseName("ix_theme_events_event_theme_id");

                    b.HasIndex("Name")
                        .HasDatabaseName("ix_theme_events_name");

                    b.ToTable("theme_events", (string)null);
                });
            ...
            modelBuilder.Entity("ItemTheme", b =>
                {
                    b.Property<string>("ItemId")
                        .HasColumnType("text")
                        .HasColumnName("item_id");
                    ...
                    b.HasKey("ItemId", "ThemesId")
                        .HasName("pk_item_theme");

                    b.HasIndex("ThemesId")
                        .HasDatabaseName("ix_item_theme_themes_id");

                    b.ToTable("item_theme", (string)null);
                });
            ...
            modelBuilder.Entity("Crpg.Domain.Entities.Themes.ThemeEvent", b =>
                {
                    b.HasOne("Crpg.Domain.Entities.Themes.Theme", "EventTheme")
                        .WithMany()
                        .HasForeignKey("EventThemeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_theme_events_themes_event_theme_id");
            ...
            modelBuilder.Entity("ItemTheme", b =>
                {
                    b.HasOne("Crpg.Domain.Entities.Items.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_theme_items_item_id");

                    b.HasOne("Crpg.Domain.Entities.Themes.Theme", null)
                        .WithMany()
                        .HasForeignKey("ThemesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_theme_themes_themes_id");
                });
