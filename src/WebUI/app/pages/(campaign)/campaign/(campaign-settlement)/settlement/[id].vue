...
import { usePartyState } from '~/composables/campaign/use-party'
import { useSettlement, useSettlementProvider } from '~/composables/campaign/use-settlements'
import { useUser } from '~/composables/user/use-user'
import { shouldPartyBeInSettlement } from '~/services/campaign/party-service'
...
definePageMeta({
  middleware: [
    async (to) => {
      ...
      const settlementId = Number((to as RouteLocationNormalizedLoaded<'campaign-settlement-id'>).params.id)
