...
// import { useCharacterCharacteristicBuilder } from '../use-character-characteristic'

// // import { createCharacteristics } from '~/services/character-service'
...
//       const { canConvertAttributesToSkills } = useCharacterCharacteristicBuilder(
//         createCharacteristics({ attributes: { points: freeAttributesPoints } }),
//       )
...
//   //   const { canConvertSkillsToAttributes } = useCharacterCharacteristicBuilder(
//   //     ref(
...
//   //       const { onInput, wasChangeMade } = useCharacterCharacteristicBuilder(
...
//   //   const { isChangeValid } = useCharacterCharacteristicBuilder(ref(createCharacteristics(characteristics)))
...
//   //   const { currentSkillRequirementsSatisfied } = useCharacterCharacteristicBuilder(
//   //     ref(createCharacteristics(characteristics)),
//   //   )
...
//   //     const { getInputProps } = useCharacterCharacteristicBuilder(
//   //       ref(createCharacteristics(characteristics)),
//   //     )
...
//   //     const { characteristics, onInput } = useCharacterCharacteristicBuilder(
...
//   //   const { characteristics, convertAttributeToSkills } = useCharacterCharacteristicBuilder(
...
//   //   const { characteristics, convertSkillsToAttribute } = useCharacterCharacteristicBuilder(
//   //     ref(createCharacteristics({ attributes: { points: 5 }, skills: { points: 10 } })),
//   //   )
...
//   //     onInput,
//   //     wasChangeMade,
//   //   } = useCharacterCharacteristicBuilder(ref(createCharacteristics({ attributes: { points: 1 } })))
...
//   //     onInput,
//   //     wasChangeMade,
//   //   } = useCharacterCharacteristicBuilder(
//   //     ref(
//   //       createCharacteristics({
