...
import type { ThemeEquipmentSlot, ThemeEventFormData, ThemeEventViewModel, ThemeViewModel } from '~/models/theme'
...
const onSubmit = () => {
  emit('submit', {
    ...
    requiredEquipmentSlotsMatchingTheme: [
      ...
      ...Array.from<ThemeEquipmentSlot>({ length: model.requiredThemedWeapons }).fill(THEME_EQUIPMENT_SLOT.Weapon),
    ],
