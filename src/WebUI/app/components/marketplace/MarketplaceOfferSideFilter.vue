...
const modelValue = defineModel<MartetplaceSideFilter>({ default: getDefaultMartetplaceSideFilterState })

const DEFAULT_GOLD_RANGE: [number, number] = [0, 10_000_000]
const DEFAULT_HEIRLOOM_POINTS_RANGE: [number, number] = [0, 10]

const isRangeFilter = (value: MartetplaceSideFilter['gold']): value is [number, number] =>
  Array.isArray(value)
