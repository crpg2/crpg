...
import type { GetActivityLogsResponse, GetBattlesByBattleIdItemsResponse, GetBattlesByBattleIdMercenaryApplicationsResponse, GetBattlesByBattleIdResponse, GetBattlesResponse, GetClansByClanIdArmoryResponse, GetGamesThemeEventsActiveResponse, GetGamesTournamentUsersResponse, GetGamesUsersResponse, GetItemsResponse, GetItemsUpgradesByBaseIdResponse, GetMarketplaceListingsHistoryResponse, GetMarketplaceListingsResponse, GetPartiesByPartyIdItemsResponse, GetPartiesSelfItemsResponse, GetPartiesSelfUpdateResponse, GetPatchNotesResponse, GetRestrictionsResponse, GetSettlementsBySettlementIdItemsResponse, GetSettlementsBySettlementIdShopItemsResponse, GetThemesEventsActiveResponse, GetThemesEventsResponse, GetUsersByIdRestrictionsResponse, GetUsersByUserIdResponse, GetUsersResponse, GetUsersSearchResponse, GetUsersSelfCharactersByIdEarningStatisticsResponse, GetUsersSelfCharactersByIdItemsResponse, GetUsersSelfCharactersByIdLimitationsResponse, GetUsersSelfItemPresetsResponse, GetUsersSelfItemsResponse, GetUsersSelfNotificationsResponse, GetUsersSelfQuestsResponse, GetUsersSelfRestrictionResponse, PostBattlesByBattleIdMercenaryApplicationsResponse, PostGamesRestrictionsResponse, PostMarketplaceListingsResponse, PostPartiesResponse, PostPartiesSelfItemsResponse, PostThemesEventsResponse, PostUsersSelfItemPresetsResponse, PostUsersSelfItemsResponse, PutBattlesByBattleIdMercenaryApplicationsByApplicationIdResponseResponse, PutGamesUsersResponse, PutItemsByBaseIdThemesResponse, PutPartiesSelfOrdersResponse, PutPartiesSelfTransferOffersByTransferOfferIdResponse, PutSettlementsBySettlementIdItemsResponse, PutThemesEventsResponse, PutUsersByUserIdNoteResponse, PutUsersSelfCharactersByIdItemsResponse, PutUsersSelfItemsByIdReforgeResponse, PutUsersSelfItemsByIdRepairResponse, PutUsersSelfItemsByIdUpgradeResponse, PutUsersSelfNotificationsByIdResponse, PutUsersSelfQuestsByIdClaimResponse } from './types.gen';
...
const themeEventViewModelSchemaResponseTransformer = (data: any) => {
    data.activeFromUtc = new Date(data.activeFromUtc);
    if (data.activeUntilUtc) {
        data.activeUntilUtc = new Date(data.activeUntilUtc);
    }
    return data;
};

const themeEventViewModelIListResultSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = data.data.map((item: any) => themeEventViewModelSchemaResponseTransformer(item));
    }
    return data;
};

export const getGamesThemeEventsActiveResponseTransformer = async (data: any): Promise<GetGamesThemeEventsActiveResponse> => {
    data = themeEventViewModelIListResultSchemaResponseTransformer(data);
    return data;
};
...
const itemViewModelResultSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = itemViewModelSchemaResponseTransformer(data.data);
    }
    return data;
};

export const putItemsByBaseIdThemesResponseTransformer = async (data: any): Promise<PutItemsByBaseIdThemesResponse> => {
    data = itemViewModelResultSchemaResponseTransformer(data);
    return data;
};
...
export const getThemesEventsResponseTransformer = async (data: any): Promise<GetThemesEventsResponse> => {
    data = themeEventViewModelIListResultSchemaResponseTransformer(data);
    return data;
};

const themeEventViewModelResultSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = themeEventViewModelSchemaResponseTransformer(data.data);
    }
    return data;
};

export const postThemesEventsResponseTransformer = async (data: any): Promise<PostThemesEventsResponse> => {
    data = themeEventViewModelResultSchemaResponseTransformer(data);
    return data;
};

export const putThemesEventsResponseTransformer = async (data: any): Promise<PutThemesEventsResponse> => {
    data = themeEventViewModelResultSchemaResponseTransformer(data);
    return data;
};

export const getThemesEventsActiveResponseTransformer = async (data: any): Promise<GetThemesEventsActiveResponse> => {
    data = themeEventViewModelIListResultSchemaResponseTransformer(data);
    return data;
};
