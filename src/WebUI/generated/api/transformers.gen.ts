...
import type { GetActivityLogsResponse, GetBattlesByBattleIdItemsResponse, GetBattlesByBattleIdMercenaryApplicationsResponse, GetBattlesByBattleIdResponse, GetBattlesResponse, GetClansByClanIdArmoryResponse, GetGamesTournamentUsersResponse, GetGamesUsersResponse, GetItemsResponse, GetItemsUpgradesByBaseIdResponse, GetMarketplaceOffersHistoryResponse, GetMarketplaceOffersResponse, GetPartiesByPartyIdItemsResponse, GetPartiesSelfItemsResponse, GetPartiesSelfUpdateResponse, GetPatchNotesResponse, GetRestrictionsResponse, GetSettlementsBySettlementIdItemsResponse, GetSettlementsBySettlementIdShopItemsResponse, GetUsersByIdRestrictionsResponse, GetUsersByUserIdResponse, GetUsersResponse, GetUsersSearchResponse, GetUsersSelfCharactersByIdEarningStatisticsResponse, GetUsersSelfCharactersByIdItemsResponse, GetUsersSelfCharactersByIdLimitationsResponse, GetUsersSelfItemPresetsResponse, GetUsersSelfItemsResponse, GetUsersSelfNotificationsResponse, GetUsersSelfRestrictionResponse, PostBattlesByBattleIdMercenaryApplicationsResponse, PostGamesRestrictionsResponse, PostMarketplaceOffersResponse, PostPartiesResponse, PostPartiesSelfItemsResponse, PostUsersSelfItemPresetsResponse, PostUsersSelfItemsResponse, PutBattlesByBattleIdMercenaryApplicationsByApplicationIdResponseResponse, PutGamesUsersResponse, PutPartiesSelfOrdersResponse, PutPartiesSelfTransferOffersByTransferOfferIdResponse, PutSettlementsBySettlementIdItemsResponse, PutUsersByUserIdNoteResponse, PutUsersSelfCharactersByIdItemsResponse, PutUsersSelfItemsByIdReforgeResponse, PutUsersSelfItemsByIdRepairResponse, PutUsersSelfItemsByIdUpgradeResponse, PutUsersSelfNotificationsByIdResponse } from './types.gen';
...
const marketplaceOfferViewModelSchemaResponseTransformer = (data: any) => {
    data.createdAt = new Date(data.createdAt);
    return data;
};

const marketplaceOffersPageViewModelSchemaResponseTransformer = (data: any) => {
    data.items = data.items.map((item: any) => marketplaceOfferViewModelSchemaResponseTransformer(item));
    return data;
};

const marketplaceOffersPageViewModelResultSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = marketplaceOffersPageViewModelSchemaResponseTransformer(data.data);
    }
    return data;
};

export const getMarketplaceOffersResponseTransformer = async (data: any): Promise<GetMarketplaceOffersResponse> => {
    data = marketplaceOffersPageViewModelResultSchemaResponseTransformer(data);
    return data;
};

const marketplaceOfferViewModelResultSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = marketplaceOfferViewModelSchemaResponseTransformer(data.data);
    }
    return data;
};

export const postMarketplaceOffersResponseTransformer = async (data: any): Promise<PostMarketplaceOffersResponse> => {
    data = marketplaceOfferViewModelResultSchemaResponseTransformer(data);
    return data;
};

const marketplaceOfferHistoryViewModelSchemaResponseTransformer = (data: any) => {
    data.acceptedAt = new Date(data.acceptedAt);
    return data;
};

const marketplaceOffersHistoryPageViewModelSchemaResponseTransformer = (data: any) => {
    data.items = data.items.map((item: any) => marketplaceOfferHistoryViewModelSchemaResponseTransformer(item));
    return data;
};

const marketplaceOffersHistoryPageViewModelResultSchemaResponseTransformer = (data: any) => {
    if (data.data) {
        data.data = marketplaceOffersHistoryPageViewModelSchemaResponseTransformer(data.data);
    }
    return data;
};

export const getMarketplaceOffersHistoryResponseTransformer = async (data: any): Promise<GetMarketplaceOffersHistoryResponse> => {
    data = marketplaceOffersHistoryPageViewModelResultSchemaResponseTransformer(data);
    return data;
};
