...
export const getUsersSelfItemPresetsByIdResponseTransformer = async (data: any): Promise<GetUsersSelfItemPresetsByIdResponse> => {
    data = userItemPresetViewModelResultSchemaResponseTransformer(data);
    return data;
};

export const putUsersSelfItemPresetsByIdResponseTransformer = async (data: any): Promise<PutUsersSelfItemPresetsByIdResponse> => {
    data = userItemPresetViewModelResultSchemaResponseTransformer(data);
    return data;
};
