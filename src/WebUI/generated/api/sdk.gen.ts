 ...
 */
export const putItemsByIdThemes = <TComposable extends Composable = '$fetch', DefaultT extends PutItemsByIdThemesResponse = PutItemsByIdThemesResponse>(options: Options<TComposable, PutItemsByIdThemesData, PutItemsByIdThemesResponse, DefaultT>) => (options.client ?? client).put<TComposable, PutItemsByIdThemesResponse | DefaultT, unknown, DefaultT>({
    responseTransformer: putItemsByIdThemesResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/Items/{id}/themes',
    ...options,
    headers: {
