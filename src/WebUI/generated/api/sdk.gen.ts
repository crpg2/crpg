 ...
 */
export const deleteBattlesByBattleIdMercenaryApplications = <TComposable extends Composable = '$fetch', DefaultT extends DeleteBattlesByBattleIdMercenaryApplicationsResponse = DeleteBattlesByBattleIdMercenaryApplicationsResponse>(options: Options<TComposable, DeleteBattlesByBattleIdMercenaryApplicationsData, DeleteBattlesByBattleIdMercenaryApplicationsResponse, DefaultT>) => {
    return (options.client ?? client).delete<TComposable, DeleteBattlesByBattleIdMercenaryApplicationsResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
