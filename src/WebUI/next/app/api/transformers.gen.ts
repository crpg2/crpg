...
import type { GetActivityLogsResponse, GetBattlesResponse, GetBattlesByBattleIdResponse, GetBattlesByBattleIdFightersResponse, PostBattlesByBattleIdFightersResponse, GetBattlesByBattleIdFighterApplicationsResponse, PutBattlesByBattleIdFighterApplicationsByApplicationIdResponseResponse, GetClansByClanIdArmoryResponse, PutClansByClanIdArmoryByUserItemIdBorrowResponse, GetGamesUsersResponse, PutGamesUsersResponse, GetGamesTournamentUsersResponse, PostGamesRestrictionsResponse, GetItemsResponse, GetItemsUpgradesByBaseIdResponse, GetPartiesSelfUpdateResponse, PostPartiesResponse, PutPartiesSelfStatusResponse, PostPartiesSelfItemsResponse, GetPatchNotesResponse, GetRestrictionsResponse, GetSettlementsResponse, GetSettlementsBySettlementIdResponse, PostSettlementsBySettlementIdResponse, GetSettlementsBySettlementIdItemsResponse, PostSettlementsBySettlementIdItemsResponse, GetSettlementsBySettlementIdShopItemsResponse, GetTerrainsResponse, PostTerrainsResponse, PutTerrainsByIdResponse, GetUsersSearchResponse, GetUsersByUserIdResponse, PutUsersByUserIdNoteResponse, GetUsersResponse, GetUsersByIdRestrictionsResponse, GetUsersSelfRestrictionResponse, GetUsersSelfCharactersByIdItemsResponse, PutUsersSelfCharactersByIdItemsResponse, GetUsersSelfCharactersByIdEarningStatisticsResponse, GetUsersSelfCharactersByIdLimitationsResponse, GetUsersSelfItemsResponse, PostUsersSelfItemsResponse, PutUsersSelfItemsByIdReforgeResponse, PutUsersSelfItemsByIdRepairResponse, PutUsersSelfItemsByIdUpgradeResponse, GetUsersSelfNotificationsResponse, PutUsersSelfNotificationsByIdResponse } from './types.gen'
...
const clanArmoryBorrowedItemViewModelSchemaResponseTransformer = (data: any) => {
...
const clanArmoryItemViewModelSchemaResponseTransformer = (data: any) => {
  ...
  data.borrowedItem = clanArmoryBorrowedItemViewModelSchemaResponseTransformer(data.borrowedItem)
  data.updatedAt = new Date(data.updatedAt)
  return data
}
...
const clanArmoryBorrowedItemViewModelResultSchemaResponseTransformer = (data: any) => {
  data.data = clanArmoryBorrowedItemViewModelSchemaResponseTransformer(data.data)
  return data
}

export const putClansByClanIdArmoryByUserItemIdBorrowResponseTransformer = async (data: any): Promise<PutClansByClanIdArmoryByUserItemIdBorrowResponse> => {
  data = clanArmoryBorrowedItemViewModelResultSchemaResponseTransformer(data)
  return data
}
