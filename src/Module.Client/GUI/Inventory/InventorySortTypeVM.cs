...
public class InventorySortTypeVM : ViewModel
{
    ...
    private readonly Action<InventorySortTypeVM>? _onAlternateClick;
    public string Id { get; }
    internal Func<InventorySlotVM, bool> Predicate { get; }

    public InventorySortTypeVM(string id, string iconSprite, Func<InventorySlotVM, bool> predicate, bool isIconVisible = true, Action<InventorySortTypeVM>? handleClick = null, Action<InventorySortTypeVM>? handleAlternateClick = null)
    {
        Id = id;
        ShowInventoryTypeIcon = isIconVisible;
        IconSprite = iconSprite;
        _onClick = handleClick;
        _onAlternateClick = handleAlternateClick;
        Predicate = predicate;
    }
