...
public class EquipmentSlotVM : ViewModel
{
    ...
    private void ExecuteHoverBegin()
    {
        ...
        {
            MBInformationManager.ShowHint(GetFriendlySlotName(_crpgItemSlotIndex) ?? "");
        }
    }
    ...
    public static string GetFriendlySlotName(CrpgItemSlot slot) => slot switch
    {
        CrpgItemSlot.Head => new TextObject("{=KC9dx232}Head").ToString(),
        CrpgItemSlot.Shoulder => new TextObject("{=KC9dx233}Shoulder").ToString(),
        CrpgItemSlot.Body => new TextObject("{=KC9dx234}Body").ToString(),
        CrpgItemSlot.Hand => new TextObject("{=KC9dx235}Gloves").ToString(),
        CrpgItemSlot.Leg => new TextObject("{=KC9dx236}Legs").ToString(),
        CrpgItemSlot.MountHarness => new TextObject("{=KC9dx237}Mount Harness").ToString(),
        CrpgItemSlot.Mount => new TextObject("{=KC9dx238}Mount").ToString(),
        CrpgItemSlot.Weapon0 => new TextObject("{=KC9dx239}Weapon 1").ToString(),
        CrpgItemSlot.Weapon1 => new TextObject("{=KC9dx240}Weapon 2").ToString(),
        CrpgItemSlot.Weapon2 => new TextObject("{=KC9dx241}Weapon 3").ToString(),
        CrpgItemSlot.Weapon3 => new TextObject("{=KC9dx242}Weapon 4").ToString(),
        CrpgItemSlot.WeaponExtra => new TextObject("{=KC9dx243}Extra Weapon").ToString(),
        _ => slot.ToString(),
    };
