...
internal class HttpCrpgClient : ICrpgClient
{
    ...
    public Task<CrpgResult<IList<CrpgEquippedItemExtended>>> UpdateCharacterEquippedItemsAsync(int userId, int characterId, CrpgGameCharacterItemsUpdateRequest req, CancellationToken cancellationToken = default)
    {
        return Put<CrpgGameCharacterItemsUpdateRequest, IList<CrpgEquippedItemExtended>>("games/users/" + userId + "/characters/" + characterId + "/items", req, cancellationToken);
    }
