...
internal sealed class UserRequestUpdateCharacterCharacteristics : GameNetworkMessage
{
    ...
    protected override bool OnRead()
    {
        ...
        Characteristics = ReadCharacteristicsFromPacket(ref bufferReadValid);
