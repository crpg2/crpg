...
internal sealed class UserRequestSpawnWithTeamEquipment : GameNetworkMessage
{
    ...
    protected override string OnGetLogFormat() => "Request cRPG Spawn With Team Equipment";
}
