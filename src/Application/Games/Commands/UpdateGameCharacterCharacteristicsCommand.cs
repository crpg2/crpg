...
public record UpdateGameCharacterCharacteristicsCommand : IMediatorRequest<CharacterCharacteristicsViewModel>
{
    [JsonIgnore]
    ...
    internal class Handler : IMediatorRequestHandler<UpdateGameCharacterCharacteristicsCommand, CharacterCharacteristicsViewModel>
    {
        private static readonly ILogger Logger = LoggerFactory.CreateLogger<UpdateGameCharacterCharacteristicsCommand>();
        ...
        public async ValueTask<Result<CharacterCharacteristicsViewModel>> Handle(UpdateGameCharacterCharacteristicsCommand req,
