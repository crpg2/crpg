...
public record GameReturnItemToClanArmoryCommand : IMediatorRequest
{
    public int UserItemId { get; init; }
    public int UserId { get; init; }
    public int ClanId { get; init; }

    internal class Handler : IMediatorRequestHandler<GameReturnItemToClanArmoryCommand>
    {
        private static readonly ILogger Logger = LoggerFactory.CreateLogger<GameReturnItemToClanArmoryCommand>();
        ...
        public async ValueTask<Result> Handle(GameReturnItemToClanArmoryCommand req, CancellationToken cancellationToken)
        {
